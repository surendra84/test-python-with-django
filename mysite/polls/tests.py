...
class QuestionModelTest(TestCase):
    def test_was_published_with_recently_future_question(self):
        """
    ...
    def test_was_published_with_recetly_old_question(self):
        """
    ...
    def test_was_published_with_recetly_recently_question(self):
        """
        was_published_recently()
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Question with a pub_date in past displayed on index page
        :return:
        """
